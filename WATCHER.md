...
When it does apply: a scheduled agent wakes up, reads what changed since the snapshot, and updates the flat
`index.md` / `log.md` append-only. The exact agent instructions live in
